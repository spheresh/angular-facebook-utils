(function(exports, global) {
    ...
    var application = angular.module("facebookUtils", []).constant("facebookConfigDefaults", defaultSettings).constant("facebookConfigSettings", defaultSettings).run([ "facebookConfigSettings", "facebookConfigDefaults", "$rootScope", "$location", "facebookUser", function(facebookConfigSettings, facebookConfigDefaults, $rootScope, $location, facebookUser) {} ]);
